...
const BottomNav = () => {
  ...
  if (!user || location.pathname.startsWith("/video-call") || location.pathname.startsWith("/audio-call") || location.pathname === "/auth" || location.pathname.startsWith("/control-room")) return null;
